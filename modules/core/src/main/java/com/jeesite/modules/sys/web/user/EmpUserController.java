...
public class EmpUserController extends BaseController {
	...
	/**
	 * 测试jeesite推送PC消息！！！！！！！！！！！！！！
	 * 注意，此处RequiresPermissions（）不能设置为sys级别
	 *
	 * @author Blooze
	 */
	@RequiresPermissions("user:empUser:myedit")
	@RequestMapping(value="sendMessage")
	@ResponseBody
	public String sendMessage(EmpUser empUser){
		EmpUser user=empUserService.get(empUser.getId());
		//测试普通发送pc端消息提示。
		MsgPushUtils.push("pc","你好","这是一条测试数据","1100593854261055488","1",user.getUserCode());
